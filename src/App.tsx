...
function LandingPage({ onStart, signedIn }: { onStart: (profile?: DoctorProfile) => void; signedIn: boolean }) {
  ...
  return (
    <div className="landing-page">
      ...
      <footer className="landing-footer"><div className="landing-brand"><div className="landing-mark"><Stethoscope size={17} /></div><strong>CliniAi</strong></div><span>Clinical decision support for clinician-led care.</span><a href="">© 2026 cliniAi. All rights reserved.</a></footer>
