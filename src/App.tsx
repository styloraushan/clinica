  ...
  const generateRecommendations = async () => {
    ...
    try {
      ...
      setNotice(
        error instanceof Error
          ? error.message
          : "Unable to generate CliniAi recommendations.",
      );
    } finally {
      setBusy("");
    }
        ...
        {view === "assessment" ? (
          <div className="content">
            <section className="page-heading">
              <div>
                <p className="eyebrow">CliniAi WORKSPACE / 01</p>
                <h1>New patient assessment</h1>
                <p className="subheading">
                  AI-assisted CliniAi decision support for a more informed
                  diagnosis.
                </p>
              </div>
              <div className="secure">
                <ShieldCheck size={17} /> Secure CliniAi workspace
              </div>
            </section>
            {notice && (
            ...
            <section className="panel confirmation-panel">
              ...
              <div className="confirmation-grid">
                <div className="ai-callout">
                  ...
                  <span>Use CliniAi judgment to confirm or adjust.</span>
                </div>
            ...
            <section className="recommendation-bar">
              <div>
                ...
                <div>
                  <strong>Ready for CliniAi recommendations?</strong>
                  <span>
  ...
  return (
    <div className="landing-page">
      ...
      <main className="landing-hero">
        <div className="landing-badge"><Activity size={14} /> AI-assisted CliniAi support</div>
        <h1>More clarity for every<br /><em>CliniAi decision.</em></h1>
        ...
        <div className="landing-preview"><div className="preview-top"><span className="preview-dot" /><span>CliniAi workspace</span><span className="preview-status"><i /> System ready</span></div><div className="preview-body"><div><span className="tiny-label">TODAY'S WORKSPACE</span><strong>Patient assessment</strong></div><div className="preview-stats"><span><b>24</b> assessments</span><span><b>98%</b> reviewed</span></div><div className="preview-line" /></div></div>
      </main>
      <section className="landing-section feature-section" id="features"><div className="landing-section-intro"><p className="landing-kicker">ONE WORKSPACE, LESS FRICTION</p><h2>Built around the way CliniAi teams work.</h2><p>Keep symptoms, model insights, doctor confirmation, and recommendations in one calm, structured workflow.</p></div><div className="landing-feature-grid"><article><div className="feature-icon"><Activity size={18} /></div><h3>Structured assessments</h3><p>Capture patient details and symptoms consistently before prediction begins.</p></article><article><div className="feature-icon"><Microscope size={18} /></div><h3>Reviewable recommendations</h3><p>See suggested medications and tests clearly, then refine them as a clinician.</p></article><article><div className="feature-icon"><ShieldCheck size={18} /></div><h3>Records you can trust</h3><p>Keep the final doctor decision and feedback alongside the original AI insight.</p></article><article><div className="feature-icon"><Search size={18} /></div><h3>Focused CliniAi review</h3><p>Search symptoms quickly and keep the selected presentation visible throughout the assessment.</p></article><article><div className="feature-icon"><ClipboardCheck size={18} /></div><h3>Clinician-led confirmation</h3><p>Record the final diagnosis separately from the AI prediction to preserve CliniAi accountability.</p></article><article><div className="feature-icon"><Printer size={18} /></div><h3>Ready-to-share case sheets</h3><p>Generate a clear case record with the assessment, final recommendations, and submitted feedback.</p></article></div></section>
      <section className="landing-section process-section" id="how"><div className="landing-section-intro"><p className="landing-kicker">A CLEAR CliniAi WORKFLOW</p><h2>From patient visit to a complete case sheet.</h2><p>CliniAi keeps the medical record, AI insight, and clinician decision in one reviewable workflow.</p></div><div className="workflow-demo" aria-label="CliniAi workflow demonstration"><div className="workflow-demo-top"><span>CliniAi WORKSPACE</span><span className="workflow-demo-status"><i /> Assessment in progress</span></div><div className="workflow-demo-steps"><div className="workflow-demo-card"><span className="workflow-demo-number">01</span><strong>Patient details</strong><small>Ananya Patel · PT-10482</small><div className="workflow-demo-tags"><b>Fever</b><b>Headache</b></div></div><ArrowRight className="workflow-demo-arrow" size={18} /><div className="workflow-demo-card"><span className="workflow-demo-number">02</span><strong>CliniAi review</strong><small>Possible condition</small><div className="workflow-demo-result"><Activity size={14} /><b>Dengue fever</b><span>82%</span></div></div><ArrowRight className="workflow-demo-arrow" size={18} /><div className="workflow-demo-card"><span className="workflow-demo-number">03</span><strong>Case sheet</strong><small>Doctor-confirmed plan</small><div className="workflow-demo-check"><Check size={14} /> Recommendations saved</div></div></div></div><div className="process-grid"><div><span>01</span><h3>Capture the CliniAi picture</h3><p>Add the patient's name, ID, age, and the symptoms observed during the consultation. This creates the context for the assessment.</p><small>Patient details and symptom list</small></div><div><span>02</span><h3>Review AI-supported possibilities</h3><p>Compare predicted conditions and confidence levels with your CliniAi judgment. AI suggests possibilities; the clinician remains the decision-maker.</p><small>Predictions, differential review, and clinician diagnosis</small></div><div><span>03</span><h3>Confirm, refine, and record</h3><p>Review recommended medicines and tests, make any needed changes, submit feedback, and generate a printable case sheet.</p><small>Final plan, feedback, and documented record</small></div></div></section>
      <section className="landing-section clinics-section" id="clinics"><div><p className="landing-kicker">FOR CLINICS AND CARE TEAMS</p><h2>Designed for thoughtful care at every scale.</h2><p>Give physicians and hospital staff a shared CliniAi workspace that keeps human judgment at the center.</p></div><button className="landing-cta large" onClick={() => onStart()}>Open the workspace <ArrowRight size={16} /></button></section>
...
function WorkspaceView({ view, history, profile, onReturn }: { view: Exclude<View, "assessment">; history: AssessmentRecord[]; profile: DoctorProfile; onReturn: () => void }) {
  ...
  return (
    <div className="content workspace-view">
      <p className="eyebrow">CliniAi WORKSPACE</p>
      <h1>{view === "history" ? "Prediction history" : view === "feedback" ? "Feedback center" : "Workspace settings"}</h1>
      <p className="subheading">{view === "history" ? "Review completed patient assessments saved." : view === "feedback" ? "Monitor clinician feedback submitted to improve recommendations." : "Review environment configuration for this workspace."}</p>
